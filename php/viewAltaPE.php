...
<html>
    ...
    <body>
        ...
        <form method="post" action="phpalta.php" style="width: 30%; margin: auto; text-align: center; padding: 5% 0 0 0;">
            ...
            <input id="activo2" type="checkbox" name="activo" placeholder="Activo" value="<?php if($actualizar){ echo $usuario->getActivo(); } ?>" />
            <label for="administrador2">Administrador</label>
            <input id="administrador2" type="checkbox" name="administrador" placeholder="Administrador" value="<?php if($actualizar){ echo $usuario->getEmail(); } ?>" disabled />
            <label for="personal2">Personal</label>
            <input id="personal2" type="checkbox" name="personal" placeholder="Personal" value="<?php if($actualizar){ echo $usuario->getEmail(); } ?>" disabled />
            <hr/>
