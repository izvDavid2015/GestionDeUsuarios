...
<html>
    ...
    <body>
        ...
        <form method="post" action="phpclaveActua.php?secreto=<?php echo Request::get("secreto") ?>" style="width: 30%; margin: auto; text-align: center; padding: 5% 0 0 0;">
            ...
            <hr/>
            <input type="password" name="claveR" placeholder="Clave repetida" required />
            <hr/>
